      ...
      <section className="pt-32 pb-20 px-6 lg:px-12">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-foreground tracking-tight leading-[1.1] mb-4">
              Request a pilot.
            </h1>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-secondary border-none rounded-lg px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-primary"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-secondary border-none rounded-lg px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1 focus:ring-primary resize-none"
