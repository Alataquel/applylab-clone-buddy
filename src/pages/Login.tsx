...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Staff side — dark (left) */}
      <div className="flex-1 bg-background flex items-center justify-center px-6 py-16 lg:py-0 relative">
      ...
      {/* Student side — white (right) */}
      <div className="flex-1 bg-white flex items-center justify-center px-6 py-16 lg:py-0">
        <div className="w-full max-w-sm">
          <a
            href="/"
