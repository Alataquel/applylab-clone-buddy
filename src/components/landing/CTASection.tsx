    ...
    <section ref={ref} id="cta" className="py-24 px-6 lg:px-12">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <a
            href="/universities"
            className="inline-flex items-center justify-center gap-2 text-muted-foreground font-medium px-8 py-3.5 rounded-full text-sm border border-muted hover:text-foreground transition-colors"
          >
            Learn how it works
          </a>
        </motion.div>
