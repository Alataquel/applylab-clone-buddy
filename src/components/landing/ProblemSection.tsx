      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <motion.div
            ...
            className="lg:col-span-5 lg:row-span-2 bg-gray-50 border border-gray-200 rounded-2xl p-8 flex flex-col justify-between min-h-[420px] hover:-translate-y-1 transition-transform duration-300"
          >
            <div>
              <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-5">
                <Eye className="w-5 h-5 text-primary" />
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3 leading-tight">No visibility</h3>
            ...
            <div className="mt-8 space-y-3">
              ...
              <p className="text-[11px] text-gray-400 mt-2">Most activity happens outside your systems</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Fragmented tools</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <div className="flex gap-2 mt-5 flex-wrap">
              {["Spreadsheets", "Job boards", "PDFs", "Email"].map((tool) => (
                <span key={tool} className="text-[10px] px-3 py-1.5 rounded-full bg-gray-100 text-gray-600 border border-gray-200">
                  {tool}
                </span>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="lg:col-span-3 bg-gray-50 border border-gray-200 rounded-2xl p-7 hover:-translate-y-1 transition-transform duration-300"
          >
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center mb-5">
              <TrendingUp className="w-5 h-5 text-emerald-500" />
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">No way to intervene</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
